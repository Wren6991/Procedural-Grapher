...
g_data parserdata;
int setdetail = 100;
std::map <std::string, tagged_value> persistent_vars;           /// we could store the parserdata state in here! Then it would be changeable from users' code using an existing mechanism.
